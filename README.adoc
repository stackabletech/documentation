...
During development, it can be helpful to use a playbook `antora-playbook-local.yml` which uses content from the local directory instead of the remote git repository.
