...
- Every service has their own authentication mechanism, but you typically want a single user:password to use everywhere
- We have Authenticationclasses
...
* Tutorial: xref:tutorials:authentication_with_openldap.adoc[]
* Reference: xref:reference:authenticationclass.adoc[]
