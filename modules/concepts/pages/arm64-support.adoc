...
WARNING: Listener operator 23.11.0 not available for the ARM64 architecture
...
NOTE: This executes a script where all operators (except Listener operator) with version 23.11.0 are installed.
