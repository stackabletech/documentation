...
Affinities can be defined at role level, group level or both. When defined at both levels, the two affinities for are merged with the group affinity taking precedence. The resulting definition is that added to the corresponding pod template.
