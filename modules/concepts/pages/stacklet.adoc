...
The processes that make up the product are divided into _roles_ and can be further subdivided into _role groups_.
...
The associated operator then creates a number of Kubernetes resources that are needed to run, configure and expose the software.
