...
These labels are attached to some parts of the Stack or demo directly installed by Stackable.
This includes the operators that are needed and additional required Kubernetes objects like Secrets or ConfigMaps.
