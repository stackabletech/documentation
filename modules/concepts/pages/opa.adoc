...
Read more about the xref:0.11@opa::index.adoc[]. Read more about product integration with OPA for these products:

* xref:0.8@trino:usage_guide:security.adoc#_authorization[Trino]
* xref:0.8@kafka::usage.adoc[Kafka]
* xref:0.8@druid::usage.adoc#_using_open_policy_agent_opa_for_authorization[Druid]
