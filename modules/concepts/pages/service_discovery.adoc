...
* xref:0.6@druid::discovery.adoc[Apache Druid]
* xref:0.4@hdfs::discovery.adoc[Apache Hadoop HDFS]
* xref:0.6@hive::discovery.adoc[Apache Hive]
* xref:0.6@kafka::discovery.adoc[Apache Kafka]
* xref:0.9@opa::discovery.adoc[OPA]
* xref:0.10@zookeeper::discovery.adoc[Apache ZooKeeper]
