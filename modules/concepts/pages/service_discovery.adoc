...
IMPORTANT: It's important that you provide *all* the information in the discovery CM and that they are up-to-date!
For Stackable managed services the Stackable operators will take care of this, when discovering external services it's your responsibility.
