...
It was decided that we will support the latest three kubernetes versions. Kubernetes release cycle is approximately 15 months, which means we support each version for 45 weeks or a little over 10 months.
...
- https://kubernetes.io/docs/reference/using-api/deprecation-policy/[Kubernetes Deprecation Poliy]
