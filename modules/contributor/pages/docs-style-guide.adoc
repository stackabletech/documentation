...
<.> Indent 2 spaces to save horizontal space (also for Python or Java code!).
...
<.> Prefix the command line with the dollar sign (`$`).
<.> Do _not_ prefix output lines.
