...
This step allows us to move away from unstable alpha or beta versions (like `v1alpha1`) to stable versions like `v1` or `v2`.
...
* Step 2: downgrade operator and webhook deployments
