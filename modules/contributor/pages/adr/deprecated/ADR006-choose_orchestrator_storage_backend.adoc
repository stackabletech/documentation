...
This ADR reflects the current state of discussion at the time of approving ADR7 and should not be considered complete!
...
** Likelihood that it is already deployed
...
* Good, because it is well established and understood
* Good, because it offers watch functionality
* Good, because it offers consensus mechanisms
