...
NOTE: Parts of this document might be out of date. The source of truth is in [operator-rs](https://github.com/stackabletech/operator-rs/tree/main/crates/stackable-operator/src/database_connections)
