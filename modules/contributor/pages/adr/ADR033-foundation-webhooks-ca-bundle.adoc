...
For reference, see the https://github.com/stackabletech/commons-operator/tree/spike/sts-restarter-webhook[commons-operator spike] and the https://github.com/stackabletech/operator-rs/pull/736[TLS utility crate PR].
