...
Read about xref:concepts:product-image-selection.adoc[] to learn how to use a particular version in your xref:stacklet.adoc[], as well as how you can use custom images or a custom registry.
