...
* Apache Spark: 1.5.0 (SDP ships with 1.5.1) added first class support for distributed training and inference support, and enhancement of compatibility for Structured streaming, Spark SQL improvements. Spark Connect is not yet supported in this release.
