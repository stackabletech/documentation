...
OpenID Connect is the de-facto authorization standard on the Web and it's making its way into enterprise environments. Apache Superset and Trino are the first products to add support for it.
