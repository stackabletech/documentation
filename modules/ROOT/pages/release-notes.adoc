...
For JVM-based products (i.e. Druid, HBase, HDFS, Hive, Kafka, Nifi, Spark, Trno and Zookeeper) it is now possible to provide custom security settings that override the default values. This allows the user to control things such as DNS lookup caches.
