...
stackablectl::
Our command line tool has been re-worked as it is now the backbone for Stackable Cockpit: you can find out about the recent enhancements by visiting the online https://docs.stackable.tech/management/stable/stackablectl/[documentation] (TODO check link).
