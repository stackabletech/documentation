...
This release introduces two further elements of platform stability - pod disruption budgets and graceful shutdown specifications - as well as a new management tool and updated product version support. Any known issues related to this release are listed below in a separate section.
...
xref:tutorials:enabling_verification_of_image_signatures.adoc[tutorial] for more information.
