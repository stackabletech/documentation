...
In the past, Helm users could not assign custom labels to stackles. This is now possible and it enables better component management with third party tools.
