...
==== Ubuntu
    apt-get install stackable-spark-operator
...
# Spark
systemctl start stackable-spark-operator
systemctl enable stackable-spark-operator
...
----
systemctl status stackable-zookeeper-operator
----
