...
== Release 22.11
This is the third release of the Stackable Data Platform, it focuses on resource management.
...
* Also the github repositories contain new and improved READMEs.
