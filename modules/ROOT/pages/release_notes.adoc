...
.*Products*
* xref:home:airflow:index.adoc[] (0.4.0)
...
* xref:home:hbase:index.adoc[] (0.3.0)
* xref:home:hdfs:index.adoc[] (0.4.0)
* xref:home:hive:index.adoc[] (0.6.0)
** Hive Metastore can index S3
* xref:home:kafka:index.adoc[] (0.6.0)
** Seamless integration with NiFi and Druid
** Supports OPA authorization
* xref:home:nifi:index.adoc[] (0.6.0)
* xref:home:spark-k8s:index.adoc[] (0.3.0)
* xref:home:superset:index.adoc[] (0.5.0)
** connects to Druid as a backend
** Supports LDAP authentication
* xref:home:trino:index.adoc[] (0.4.0)
** Supports OPA and file-based authorization
** Connects to the Hive Metastore
** Query data from S3
** TLS support
* xref:home:zookeeper:index.adoc[] (0.10.0)
...
* xref:home:opa:index.adoc[] (0.9.0)
** Create RegoRules in ConfigMaps
* xref:home:commons-operator:index.adoc[] (0.2.0)
* xref:home:secret-operator:index.adoc[] (0.5.0)
