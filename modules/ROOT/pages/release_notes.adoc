...
The `loadExamplesOnInit` option was removed from the `SupersetCluster` CRD. Loading examples is still supported, the process is now described in the https://docs.stackable.tech/home/stable/superset/getting_started/first_steps[documentation].
