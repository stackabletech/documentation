...
:description: The Stackable Data Platform installs on OVH Managed Kubernetes Service out of the box; the ephemeral-nodes ListenerClass preset is recommended.
