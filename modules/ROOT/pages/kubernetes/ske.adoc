...
:description: Set up the STACKIT Kubernetes Engine (SKE) for the Stackable Data Platform, including assigning public IPs to nodes since SKE does not do so by default.
