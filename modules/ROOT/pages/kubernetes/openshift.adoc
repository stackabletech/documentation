= Red Hat OpenShift
:description: Run the Stackable Data Platform on Red Hat OpenShift. Covers certified operators from the OperatorHub, Subscription customization and security context constraints.
