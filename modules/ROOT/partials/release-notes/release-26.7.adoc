...
* In addition to the existing CycloneDX SBOMs, every image now also has an SBOM in the https://spdx.dev/[SPDX] format attested to it.
  See the xref:guides:viewing-and-verifying-sboms.adoc[SBOM guide] in our documentation for how to verify and extract them.
